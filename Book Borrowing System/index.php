...
<head>
    ...
    <link rel="stylesheet" href="/Bookie/assets/css/styles.css?v=<?php echo time(); ?>">
    ...
    <div class="card-container">
        <div class="card">
            <div class="card-content">
                <img src="/Bookie/assets/img/book-1.jpg" alt="">
        ...
        <div class="card">
            <div class="card-content">
                <img src="/Bookie/assets/img/book-2.jpg" alt="">
        ...
        <div class="card">
            <div class="card-content">
                <img src="/Bookie/assets/img/book-3.jpg" alt="">
        ...
        <div class="card">
            <div class="card-content">
                <img src="/Bookie/assets/img/book-4.jpg" alt="">
        ...
        <div class="card">
            <div class="card-content">
                <img src="/Bookie/assets/img/book-5.jpg" alt="">
                <h3>The Guardian</h3>
        ...
        <div class="card">
            <div class="card-content">
                <img src="/Bookie/assets/img/book-6.jpg" alt="">
            ...
            <form action="#" class="form">
                ...
                <div class="input-box">
                    <div class="form-select-box">
                        <select>
                            ...
                            <option value="1">Playing In The Rain</option>
                            <option value="2">The Way We Forgive</option>
                            <option value="3">Galactic Terror</option>
                            <option value="4">May It Please The Court</option>
                            <option value="5">The Guardian</option>
                            <option value="6">Within and Without Time</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-column">
                    <div class="input-box">
                        ...
                        <input type="date" placeholder="username" name="username" required>
                    </div>
                    <div class="input-box">
